...
model = torch.load("29classes_cp_12k_steps_ckgresnet+nonseparable+h_s-32_32_64+k-7+om-10.0+f_om-10.0+do-0.0+wd-0.0001+n_el-8+grp-SE2+smplng-uniform+implm-SIREN+ds-SUAS.pt",
